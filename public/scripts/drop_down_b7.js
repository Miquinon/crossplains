document.addEventListener("DOMContentLoaded", function () {
    const sizeDropdownB7 = document.getElementById("size-b7");
    const typeDropdownB7 = document.getElementById("type-b7"); // Changed from pounds to type

    const productNameB7 = "studs"; // Set dynamically if needed
